...
alpha_t.fixed <- iterate.f1p(eq3.012.alpha_t,alpha_0.fixedPoint,iterations)
alpha_t.decrease <- iterate.f1p(eq3.012.alpha_t,alpha_0.lessThanFixedPoint,iterations)
alpha_t.increase <- iterate.f1p(eq3.012.alpha_t,alpha_0.moreThanFixedPoint,iterations)
